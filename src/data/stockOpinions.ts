...
export const stockOpinions: StockOpinion[] = [
  ...
  // --- 期货 ---
  {
    ...
    sector: '期货',
    rating: 'HOLD',
    content: '贯穿历史的天然货币与终极避险资产。一月涨的太多了，就算有回调，现在还是在50日均线以上。伊朗跟美伊一打，现在还在涨，快到前高了，又考虑到全球法币的信用，长期看多，适合作为投资组合的压舱石。'
  },
  {
    symbol: 'SILVER',
    name: 'Silver Futures',
    sector: '期货',
    rating: 'SELL',
    content: '还是涨太多了。跟黄金不同，银可以是工业产品，超过100严重偏离产业基本面，后续会继续回调到适合的位置。'
  },
